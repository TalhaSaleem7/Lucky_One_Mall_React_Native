...
import { SafeAreaView, View, Text, Image, ScrollView, StyleSheet, TouchableOpacity, ImageBackground, Dimensions } from 'react-native';
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={styles.header}>
          <Image 
            source={{uri: 'https://epicnap.appssols.com/images/avatar.png'}} 
          ...
          <View style={styles.headerIcons}>
            ...
            <TouchableOpacity>
              <Image 
                source={{uri: 'https://epicnap.appssols.com/images/scan.png'}} 
                style={styles.icon} 
              />
            </TouchableOpacity>
              ...
              <TouchableOpacity>
              <Image 
                source={{uri: 'https://epicnap.appssols.com/images/Messages.png'}} 
                style={styles.icon} 
              />
            </TouchableOpacity>
             ...
             <TouchableOpacity>
              <Image 
                source={{uri: 'https://epicnap.appssols.com/images/Settings.png'}} 
                style={styles.icon} 
              />
            </TouchableOpacity>
          </View>
        ...
        <ScrollView horizontal style={styles.discounts}>
          {['kfc', 'mcd', 'pizzahut', 'california', 'kfc'].map((brand, index) => (
            <Image 
              key={index} 
              source={{uri: 'https://epicnap.appssols.com/images/california.png'}} 
        ...
        <Image 
            source={{uri: 'https://epicnap.appssols.com/images/clock.png'}} 
        ...
        <View style={styles.offerList}>
          {Array(6).fill().map((_, index) => (
            <Image 
              key={index} 
              source={{uri: 'https://epicnap.appssols.com/images/food.png'}} 
        ...
        <View style={styles.vouchers}>
          <Image 
            source={{uri: 'https://epicnap.appssols.com/images/banner2.png'}} 
        ...
        <Image 
            source={{uri: 'https://epicnap.appssols.com/images/Button.png'}} 
         ...
         <ScrollView horizontal={true} style={styles.offerLists}>
          {Array(3).fill().map((_, index) => (
            ...
            <Image 
              ...
              source={{uri: 'https://epicnap.appssols.com/images/red.png'}} 
