        ...
        if (response.ok) {
            ...
            setorderid(data.Job_details.Order_Id)
              ...
              if(data.Job_details.phase==="Currently in Pick a Vendor Phase")
                ...
                if(data.Job_details.phase==="Currently in a Vendor Visit Phase" || data.Job_details.phase==="Quotes Created" )
                    {
                        setphase2(true)
                        setphase3(true)
...
/>
    ...
    <View style={{backgroundColor:'#1E1E1E' ,width:270,height:70,justifyContent:"space-around",borderRadius:2,marginRight:10}}>
    ...
    <TouchableOpacity style={{backgroundColor:'#1AC1F3',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Created_Job}>
    
    <Text style={{color:'#002758'}}>
        View
    </Text>
...
/>
    ...
    <View>
        ...
        {
            phase2 &&
    <TouchableOpacity style={{backgroundColor:'#1AC1F3',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Select_Vendor}>
...
/>
    ...
    <TouchableOpacity style={{backgroundColor:'#1AC1F3',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Select_Quotes}>
...
/>
    ...
    <View>
        ...
        {
            phase4 &&
    <TouchableOpacity style={{backgroundColor:'#1AC1F3',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Payment}>
...
<View style={{justifyContent:'flex-start',flexDirection:'row',paddingBottom:10,paddingLeft:20}}>
    ...
    <Text style={{color:'#A3A3A3'}}>
    You can easily pay to vendor its secure.
    </Text>
</View>
...

{
    ...
    <TouchableOpacity style={{backgroundColor:'#1AC1F3',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Chat}>
...
<View style={{justifyContent:'flex-start',flexDirection:'row',paddingBottom:10,paddingLeft:20}}>
    ...
    <Text style={{color:'#A3A3A3'}}>
    Communication is the key, Chat now!
    </Text>
</View>
...
<View>

    {
        ...
        phase6 &&
<TouchableOpacity style={{backgroundColor:'#1AC1F3',width:80,height:30,borderRadius:5,alignItems:'center',justifyContent:'center',marginTop:10}} onPress={Go_To_Review}>
